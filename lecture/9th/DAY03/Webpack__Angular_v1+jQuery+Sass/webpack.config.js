...
let path              = require('path');    // 경로를 알려주는 모듈
let ExtractTextPlugin = require('extract-text-webpack-plugin'); // internal로 들어가는 코드를 외부로 분리
...
const CONFIG = {
  ...
  'JS_BUNDLE' : 'app.js',
  // Autoprefixer 브라우저 설정 // 밴더 프리픽스를 자동으로 붙여줌
...
module.exports = {
  ...
  'module': {
    ...
    'loaders': [
      ...
      // Babel Loader ------------------------------------------------------
      {
        ...
        'loader': 'babel',
        'query': {
          'cacheDirectory' : true,  // 바뀐것만 수정하도록 
          'presets'        : ['es2015']
        }
      },
      ...
      // Images, Fonts Loader ----------------------------------------------
      {
        ...
        'exclude': /node_modules/,
        'loader': 'url-loader?limit=100000' // 로딩 제한 사이즈 : 100kb 
      },
  ...
  'plugins': [
    ...
    // 멀티 페이지 번들 플러그인 3.******
    // 참고) http://i5on9i.blogspot.kr/2016/07/nodejs-commonschunkplugin.html
