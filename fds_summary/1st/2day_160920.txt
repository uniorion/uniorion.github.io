...
viewport : 웹이보이는 화면 크기 ( 10vh > 브라우저 사이즈의 1/10)

block 모델을 가로로 배치하려면 부모의 display 속성을 flex로 변경
...
>> 속성의 값을 재정의 할 경우, 선택자의 구체성이 높은것이 적용된다. 같을경우 나중에 적용한것
